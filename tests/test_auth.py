"""Auth and routing tests for PR-0.
...
async def test_valid_key_allows_models(client, api_key):
    """/v1/models with correct bearer key returns 200 and OpenAI list shape."""
...
def test_settings_fail_without_key(monkeypatch):
    """App must refuse to start when GATEWAY_API_KEY is missing."""
...
async def test_key_check_uses_constant_time_compare(client, api_key):
